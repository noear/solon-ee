...
public class LicenceUtilExt extends LicenceUtil {
    ...
    private static RsaUtil RSA512 = new RsaUtil(512);
        ...
        if (description == null) {
            try {
                ...
                if (Utils.isNotEmpty(appLicence)) {
                    String licenceStr = RSA512.decryptFromBase64(appLicence, PRIVATE_KEY);
                    ...
                    if (licence.length == 3) {
                        ...
                        if (edition == 2 || edition == 3) {
                            ...
                            if (edition == 3) {
                                buf.append("Edition=Enterprise Ultimate, ");
                            } else {
                                buf.append("Edition=Enterprise Premium, ");
                            }
